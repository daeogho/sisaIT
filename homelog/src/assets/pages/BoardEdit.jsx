...
const BoardEdit = () => {
        ...
        console.log("edit받은 값=", board_no)

        //폼의 데이터를 담을 변수 =
        const [boardData, setBoardData] = useState({}) // {subject:'ddddd', 'content:'ccccc'}
        const setBoardFormData = (event) => {
        ...
        useEffect(() => {
                if (boardData.context && editorRef.current) {
                        editorRef.current.getInstance().setHTML(boardData.context)
                }
        }, [boardData]) // DB에서 불러온 글 (에디터)
                ...
                axios.post('http://192.168.4.86:9988/board/edit', sendData)
                        .then((response) => {
                                ...
                                if (response.data.result == 'success') {
                                        alert("게시글이 수정되었습니다.");
                                        window.location.href = '/member/boardview/' + boardData.no
                                } else {
                                        alert("수정 실패");
                                }
                        })
        ...
        return (
                <div className="editform" style={{ width: '1500px', margin: '50px auto' }}>
                        ...
                        <div className='main-logo'
                                ...
                                <img src='/src/assets/img/writeicon.png'
                        ...
                        <form onSubmit={boardWrite}>
                                <div div className='editor-section'>
                                      <div style={{
                                ...
                                <p style={{ fontSize: '1.3em', color: 'grey' }}>내용</p>
                                <Editor
                                        ref={editorRef}
                                        height="700px"
