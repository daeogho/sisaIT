...
server.listen(12014, function () {
        console.log("chatting server start.... http://127.0.0.1:12014/chatform")
});
...
io.sockets.on('connection', (socket)=>{
        ...
        socket.on('hello', function(msg){
                ...
                // [private통신] : 특정 클라이언트에게만 데이터를 전송한다.
                io.sockets.in(id).emit('hi', '[private통신]=>'+msg);
        });
});