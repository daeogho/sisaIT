...
<div class="board-main">
	<!-- 에디터 영역 -->
	<form action="${ctx}/season/writeOk" method="post" onsubmit="return submitEditor();" enctype="multipart/form-data" >
		...
		<div style="width:90%; border-bottom: 2px solid #E6B677; border-top: 2px solid #E6B677; margin:20px auto; ">
			...
			<input type="text" id="subject" name="subject"  placeholder="제목을 입력하세요.(최대 30글자)"
			...
			<input type="text" id="addrtitle" name="addrtitle" placeholder="지도에서 선택시 자동입력됩니다."
				style="width: 80%; min-height: 40px; resize: none;
				overflow: hidden; box-sizing: border-box; border: none; border-bottom: 1px solid #eee;
		    ...
		    <div id="menu_wrap" class="bg_white">
		        <div class="option">
		            <div>
		                <div>
						    키워드 : 
						    <input type="text" value="제주 시청" id="keyword" placeholder="장소를 입력하세요." size="15"> 
	    ...
	    <div>
			<button type="submit" class="diphylleia-regular-button" onclick="" style="width:150px;background-color:#aaa; border: 0px; border-radius:10px; padding:5px;">글 등록</button>
		</div>
	</form>
